...
const Cart = () => {
  return (
    <div className='w-full md:py-20'>
        <Wrapper>
            <div className='text-center max-w-w[800px] mx-auto mt-8 md:mt-0'>
            ...
            <div className='flex flex-col lg:flex-row gap-12 py-10'>
                ...
                {/* summary - payment, coupons, shipping */}
            ...
            <div className='flex-[2] flex flex-col items-center pb-[50px] md:-mt-18'>
                <Image 
